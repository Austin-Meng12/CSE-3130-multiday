"""
Title: Brick Break game Class
Author: Austin Meng
date-created: May, 7,2023
"""
...
class Engine:
    ...
    def __init__(self):
        ...
        self.__TITLE.setPos((self.__WINDOW.getWidth()//2 - self.__TITLE.getWidth()//2 - 70,
                             self.__WINDOW.getHeight()//2 - self.__TITLE.getHeight()//2 + 40 ))
        self.__TITLE.setFontSize(64)
        ...
        self.__TITLE_2.setPos((self.__WINDOW.getWidth()//2 - self.__TITLE_2.getWidth()//2 +50,
                               self.__WINDOW.getHeight() - self.__TITLE_2.getHeight()//2 - 180
        ...
        self.__TITLE_LEVEL.setPos((self.__WINDOW.getWidth()//2 - self.__TITLE_LEVEL.getWidth() + 40, 0))
        ...
        self.__SCORE_TEXT.setPos((self.__WINDOW.getWidth() - self.__SCORE_TEXT.getWidth() , 0))
        self.__SCORE_TEXT.setFontSize(30)

        # LIVES TEXT
        self.__LIVES = 5
        self.__LIVES_TEXT = Text(f"LIVES: {self.__LIVES}")
        self.__LIVES_TEXT.setPos((0, 0))
        self.__LIVES_TEXT.setFontSize(30)
        ...
        self.__BRICK_START_X = 90  # Starting X Value for the brick
        self.__BRICK_START_Y = self.__TITLE_2.getHeight() + 55 # Starting Y value for the brick
        ...
        for i in range(6):
            self.__BRICK.append(Brick(40,100))
        ...
        self.__BRICK_START_X = 90
        for i in range(6):
            self.__BRICK_2.append(Brick(40,100))
            self.__NUMBER_OF_BRICKS += 1
        for brick in self.__BRICK_2:
            ...
            brick.setBrickPos(self.__BRICK_START_X, self.__BRICK_START_Y)
            self.__BRICK_START_X += 5 + brick.getWidth()
        self.__BRICK_START_Y += self.__BRICK_2[0].getHeight() + 15



        self.__BRICK_START_X = 90
        for i in range(6):
            self.__BRICK_3.append(Brick(40,100))
            self.__NUMBER_OF_BRICKS += 1
        for brick in self.__BRICK_3:
            ...
            brick.setBrickPos(self.__BRICK_START_X, self.__BRICK_START_Y)
            self.__BRICK_START_X += 5 + brick.getWidth()
        self.__BRICK_START_Y += self.__BRICK_3[0].getHeight() + 15

        self.__BRICK_START_X = 90
        for i in range(6):
            self.__BRICK_4.append(Brick(40,100))
            self.__NUMBER_OF_BRICKS += 1
        for brick in self.__BRICK_4:
            ...
            brick.setBrickPos(self.__BRICK_START_X, self.__BRICK_START_Y)
            self.__BRICK_START_X += 5 + brick.getWidth()
        self.__BRICK_START_Y += self.__BRICK_4[0].getHeight() + 15
        ...
        for i in range(7):
             ...
             self.__BRICK_21.append(Brick(20,100))
        ...
        for i in range(5):
            self.__NUMBER_LEVEL_TWO_BRICKS += 1
            self.__BRICK_22.append((Brick(20, 110)))
        ...
        for i in range(5):
            self.__NUMBER_LEVEL_TWO_BRICKS += 1
            self.__BRICK_23.append(Brick(20,100))
        ...
        for i in range(4):
            self.__NUMBER_LEVEL_TWO_BRICKS += 1
            self.__BRICK_24.append(Brick(20,100))
        ...
        for i in range(3):
            self.__NUMBER_LEVEL_TWO_BRICKS += 1
            self.__BRICK_25.append(Brick(20,100))
        ...
        for i in range(1):
            self.__NUMBER_LEVEL_TWO_BRICKS += 1
            self.__BRICK_26.append(Brick(20,120))
    ...
    def run(self):
        ...
        while True:
            ...
            if self.__BALL._OUT_OF_BOUNDS == True:  # The ball leaves the very bottom of the screen
                ...
                self.__LIVES_TEXT.setFontSize(30)
                self.__LIVES_TEXT.setPos((0, 0))
                self.__BALL.setPos((self.__PLAYER.getX() + self.__PLAYER.getWidth()//2, self.__PLAYER.getY() - 20))
           ...
           ### COLLISIONS IN THE GAME
            ...
            for brick in self.__BRICK:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    ...
                    if brick._BRICK_DEAD == True:
                        ...
                        self.removeFirstLevelBrick(self.__BRICK, brick,4)
            for brick in self.__BRICK_2:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    self.__BALL.determineBoxDirection(brick.getPos(), brick.getDimensions())
                    brick.LoseHealth()
                    ...
                    if brick._BRICK_DEAD == True:
                        ...
                        self.removeFirstLevelBrick(self.__BRICK_2, brick,3)
            ...
            for brick in self.__BRICK_3:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    ...
                    if brick._BRICK_DEAD == True:
                        ...
                        self.removeFirstLevelBrick(self.__BRICK_3, brick,2)
            ...
            for brick in self.__BRICK_4:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    ...
                    if brick._BRICK_DEAD == True:
                        ...
                        self.removeFirstLevelBrick(self.__BRICK_4, brick,1)
            ...
            for brick in self.__BRICK_21:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    ...
                    if brick._BRICK_DEAD == True:
                        self.removeFirstLevelBrick(self.__BRICK_21, brick,3)
            ...
            for brick in self.__BRICK_22:
                if self.__BALL.BALLBRICKCollision(brick.getPos(),brick.getDimensions()):
                    ...
                    brick.DetermineBrickHealthColor((255,215,0),(255,125,64),(205,16,118))
                    if brick._BRICK_DEAD == True:
                        self.removeFirstLevelBrick(self.__BRICK_22, brick,3)
            ...
            for brick in self.__BRICK_23:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    ...
                    brick.DetermineBrickHealthColor((255, 215, 0), (255, 125, 64), (205, 16, 118))
                    if brick._BRICK_DEAD == True:
                        self.removeFirstLevelBrick(self.__BRICK_23, brick,3)
            for brick in self.__BRICK_24:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    self.__BALL.determineBoxDirection(brick.getPos(), brick.getDimensions())
                    brick.LoseHealth()
                    brick.DetermineBrickHealthColor((255, 215, 0), (255, 125, 64), (205, 16, 118))
                    if brick._BRICK_DEAD == True:
                        self.removeFirstLevelBrick(self.__BRICK_24, brick,3)
            for brick in self.__BRICK_25:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    self.__BALL.determineBoxDirection(brick.getPos(), brick.getDimensions())
                    brick.LoseHealth()
                    brick.DetermineBrickHealthColor((255, 215, 0), (255, 125, 64), (205, 16, 118))
                    if brick._BRICK_DEAD == True:
                        self.removeFirstLevelBrick(self.__BRICK_25, brick,3)
            for brick in self.__BRICK_26:
                if self.__BALL.BALLBRICKCollision(brick.getPos(), brick.getDimensions()):
                    self.__BALL.determineBoxDirection(brick.getPos(), brick.getDimensions())
                    brick.LoseHealth()
                    brick.DetermineBrickHealthColor((255, 215, 0), (255, 125, 64), (205, 16, 118))
                    if brick._BRICK_DEAD == True:
                        self.removeFirstLevelBrick(self.__BRICK_26, brick,3)
    ...
    def removeFirstLevelBrick(self,LIST,BRICK,SCORE):
        """
        ...
        self.__SCORE_TEXT.setPos((self.__WINDOW.getWidth() - self.__SCORE_TEXT.getWidth(), 0))
        self.__SCORE_TEXT.setFontSize(30)
    def removeSecondLevelBrick(self,LIST, BRICK,SCORE):
        """
    ...
    def addScore(self, SCORE):
        """
        Adding the score after the brick is gone
        :param SCORE: int
        :return:
        """
        self.__SCORE += SCORE
